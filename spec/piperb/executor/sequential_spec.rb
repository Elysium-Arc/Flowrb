...
RSpec.describe Piperb::Executor::Sequential do
  ...
  describe '#execute' do
    ...
    it 'passes initial_input to root steps' do
      dag.add(make_step(:process, &:upcase))
    ...
    context 'with errors' do
      ...
      it 'stops execution after first failure' do
        ...
        expect { executor.execute }.to raise_error(Piperb::StepError)
      ...
      it 'validates DAG before execution' do
        ...
        expect { executor.execute }.to raise_error(Piperb::MissingDependencyError)
      end
    end
  end
end

RSpec.describe Piperb::Executor::Base do
  describe '#execute' do

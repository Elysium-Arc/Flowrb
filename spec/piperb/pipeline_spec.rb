...
RSpec.describe Piperb::Pipeline do
  ...
  describe '#validate!' do
    ...
    it 'raises MissingDependencyError for unknown dependencies' do
      ...
      expect { pipeline.validate! }.to raise_error(Piperb::MissingDependencyError)
    end
  end
...
RSpec.describe Piperb do
  describe '.define' do
    it 'creates a pipeline' do
      ...
      expect(pipeline).to be_a(Piperb::Pipeline)
      expect(pipeline[:fetch]).not_to be_nil
    end
  end
end

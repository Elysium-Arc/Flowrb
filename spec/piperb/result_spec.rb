...
RSpec.describe Piperb::Result do
  let(:step_result) do
    Piperb::StepResult.new(step_name: :fetch, output: [1, 2, 3], status: :success)
  end
  ...
  describe '#success?' do
    ...
    it 'returns false when any step failed' do
      failed = Piperb::StepResult.new(step_name: :process, error: StandardError.new)
  ...
  describe '#outputs' do
    it 'returns hash of step outputs' do
      result1 = Piperb::StepResult.new(step_name: :a, output: 1, status: :success)
      result2 = Piperb::StepResult.new(step_name: :b, output: 2, status: :success)
